...
class LocationController {
    sedeRepository = config_1.AppDataSource.getRepository(Sede_1.Sede);
    ubicacionRepository = config_1.AppDataSource.getRepository(Ubicacion_1.Ubicacion);
    // ==================== SEDES ====================
    /**
    ...
    async getAllSedes(req, res) {
        try {
            ...
            const sedesWithCounts = sedes.map(sede => ({
                ...
                totalExtintores: sede.ubicaciones?.reduce((total, ubicacion) => total + (ubicacion.extintores?.length || 0), 0) || 0
            }));
            res.json((0, helpers_1.successResponse)(sedesWithCounts));
        }
        catch (error) {
    ...
    async getSedeById(req, res) {
        try {
            ...
            const sede = await this.sedeRepository
                ...
                .getOne();
            if (!sede) {
                res.status(404).json((0, helpers_1.errorResponse)('Sede no encontrada'));
                return;
            }
            res.json((0, helpers_1.successResponse)(sede));
        }
        catch (error) {
    ...
    async createSede(req, res) {
        try {
            ...
            if (existingSede) {
                res.status(400).json((0, helpers_1.errorResponse)('Ya existe una sede con ese nombre'));
                return;
            }
            const sede = new Sede_1.Sede();
            sede.nombre = nombre;
            sede.direccion = direccion;
            const savedSede = await this.sedeRepository.save(sede);
            // Log de la acción
            await (0, helpers_1.logUserAction)(req, 'CREAR', 'SEDE', `Sede creada: ${savedSede.nombre}`);
            res.status(201).json((0, helpers_1.successResponse)(savedSede));
        }
        catch (error) {
    ...
    async updateSede(req, res) {
        try {
            ...
            // Log de la acción
            await (0, helpers_1.logUserAction)(req, 'ACTUALIZAR', 'SEDE', `Sede actualizada: ${updatedSede.nombre}`);
            res.json((0, helpers_1.successResponse)(updatedSede));
        }
        catch (error) {
    ...
    async deleteSede(req, res) {
        try {
            ...
            const hasExtintores = sede.ubicaciones?.some(ubicacion => ubicacion.extintores && ubicacion.extintores.length > 0);
            if (hasExtintores) {
                res.status(400).json((0, helpers_1.errorResponse)('No se puede eliminar la sede porque tiene extintores asociados'));
                return;
            }
            await this.sedeRepository.remove(sede);
            // Log de la acción
            await (0, helpers_1.logUserAction)(req, 'ELIMINAR', 'SEDE', `Sede eliminada: ${sede.nombre}`);
            res.json((0, helpers_1.successResponse)({ message: 'Sede eliminada exitosamente' }));
        }
        catch (error) {
    ...
    async getAllUbicaciones(req, res) {
        try {
            ...
            res.json((0, helpers_1.successResponse)(ubicacionesWithCounts));
        }
        catch (error) {
     ...
     */
    async getUbicacionesBySede(req, res) {
        try {
    ...
    async getUbicacionById(req, res) {
        try {
            ...
            const ubicacion = await this.ubicacionRepository
                ...
                .getOne();
            if (!ubicacion) {
                res.status(404).json((0, helpers_1.errorResponse)('Ubicación no encontrada'));
                return;
            }
            res.json((0, helpers_1.successResponse)(ubicacion));
        }
        catch (error) {
    ...
    async createUbicacion(req, res) {
        try {
            ...
            if (!sede) {
                res.status(400).json((0, helpers_1.errorResponse)('La sede especificada no existe'));
                return;
            }
            ...
            if (existingUbicacion) {
                res.status(400).json((0, helpers_1.errorResponse)('Ya existe una ubicación con ese nombre en la sede seleccionada'));
                return;
            }
            const ubicacion = new Ubicacion_1.Ubicacion();
            ...
            const fullUbicacion = await this.ubicacionRepository
                ...
                .getOne();
            // Log de la acción
            await (0, helpers_1.logUserAction)(req, 'CREAR', 'UBICACION', `Ubicación creada: ${savedUbicacion.nombre_area} en ${sede.nombre}`);
            res.status(201).json((0, helpers_1.successResponse)(fullUbicacion));
        }
        catch (error) {
    ...
    async updateUbicacion(req, res) {
        try {
            ...
            const fullUbicacion = await this.ubicacionRepository
                ...
                .getOne();
            // Log de la acción
            await (0, helpers_1.logUserAction)(req, 'ACTUALIZAR', 'UBICACION', `Ubicación actualizada: ${updatedUbicacion.nombre_area}`);
            res.json((0, helpers_1.successResponse)(fullUbicacion));
        }
        catch (error) {
    ...
    async deleteUbicacion(req, res) {
        try {
            ...
            if (ubicacion.extintores && ubicacion.extintores.length > 0) {
                res.status(400).json((0, helpers_1.errorResponse)('No se puede eliminar la ubicación porque tiene extintores asociados'));
                return;
            }
            await this.ubicacionRepository.remove(ubicacion);
            // Log de la acción
            await (0, helpers_1.logUserAction)(req, 'ELIMINAR', 'UBICACION', `Ubicación eliminada: ${ubicacion.nombre_area}`);
            res.json((0, helpers_1.successResponse)({ message: 'Ubicación eliminada exitosamente' }));
        }
        catch (error) {
