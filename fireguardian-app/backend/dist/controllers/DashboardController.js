...
class DashboardController {
    ...
    static async getStats(req, res) {
        try {
            ...
            const sedeRepo = config_1.AppDataSource.getRepository(Sede_1.Sede);
            const mantenimientoRepo = config_1.AppDataSource.getRepository(Mantenimiento_1.Mantenimiento);
            ...
            res.json((0, helpers_1.createApiResponse)(true, stats, 'Estadísticas obtenidas exitosamente'));
        }
        catch (error) {
    ...
    static async getRecentActivity(req, res) {
        try {
            ...
            res.json((0, helpers_1.createApiResponse)(true, actividadReciente, 'Actividad reciente obtenida exitosamente'));
        }
        catch (error) {
    ...
    static async getPerformanceMetrics(req, res) {
        try {
            ...
            res.json((0, helpers_1.createApiResponse)(true, metricas, 'Métricas de rendimiento obtenidas exitosamente'));
        }
        catch (error) {
    ...
    static async getAlerts(req, res) {
        try {
            ...
            res.json((0, helpers_1.createApiResponse)(true, alertas, 'Alertas obtenidas exitosamente'));
        }
        catch (error) {
